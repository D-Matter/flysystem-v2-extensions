...
namespace Ambient\Files\Adapter\AwsS3;

use Aws\Api\DateTimeResult;
use Aws\S3\S3ClientInterface;
use Ambient\Files\Adapter\ExtendedAdapterInterface;
use Ambient\Files\Attributes\DirectoryAttributes;
use Ambient\Files\Attributes\FileAttributes;
...
class AwsS3Adapter extends AwsS3V3Adapter implements ExtendedAdapterInterface
{
